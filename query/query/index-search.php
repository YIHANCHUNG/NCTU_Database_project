...
<div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
		...
		~
		<input type="text" name="view_upper" value="2147483647"><br>
		like:
		<input type="text" name="like_lower" value="0">
		~
		<input type="text" name="like_upper" value="2147483647"><br>
		dislike:
		<input type="text" name="dislike_lower" value="0">
		~
		<input type="text" name="dislike_upper" value="2147483647"><br>
