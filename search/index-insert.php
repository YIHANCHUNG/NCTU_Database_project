...
<div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
		...
		views:
		<input type="text" name="views" placeholder="Insert views"><br>
		likes:
		<input type="text" name="likes" placeholder="Insert likes"><br>
		dislikes:
		<input type="text" name="dislikes" placeholder="Insert dislikes">
		comment count:
		<input type="text" name="comment_count" placeholder="Insert comment count">
		thumbnail link:
